\hypertarget{prep__000-abstract.md}{}
\hypertarget{prep__000-abstract.md__abstract}{%
\chapter*{Abstract}\label{prep__000-abstract.md__abstract}}

\protect\hyperlink{prep__010-introduction.md__background}{TEST3}
...
\hypertarget{prep__001-preamble.md}{}
\tableofcontents
...
\hypertarget{prep__010-introduction.md}{}
\hypertarget{prep__010-introduction.md__introduction}{%
\chapter{Introduction}\label{prep__010-introduction.md__introduction}}
...
\hypertarget{prep__010-introduction.md__background}{%
\section{Background}\label{prep__010-introduction.md__background}}
...
Wikipedia \autocite{wikiMPC}. Yao's Millionaires' Problem
\autocite{yaoProtocolsSecureComputations1982} is one famous example in
which a number of millionaires want to know who is richer without
revealing their net worths. Other practical applications
\autocite{laudApplicationsSecureMultiparty2015} include electronic
voting, auctions or even machine learning
\autocite{knottCrypTenSecureMultiParty2022} where one party's private
data can be used as an input for another party's private machine
learning model.
...
\hypertarget{prep__010-introduction.md__problem-description}{%
\section{Problem
description}\label{prep__010-introduction.md__problem-description}}
...
\hypertarget{prep__010-introduction.md__research-questions}{%
\section{Research
questions}\label{prep__010-introduction.md__research-questions}}
...
\hypertarget{prep__010-introduction.md__preparation-phase-scope}{%
\section{Preparation phase
scope}\label{prep__010-introduction.md__preparation-phase-scope}}
...
\item
  ...
  \item
    ...
    from scratch at any time; as in the famous DevOps analogy
    \autocite{biasHistoryPetsVs2016}, it should be based on machines
    that are like cattle rather than pets
  \end{itemize}
\item
  Connectivity
...
\hypertarget{prep__030-technical-survey.md}{}
\hypertarget{prep__030-technical-survey.md__technical-survey}{%
\chapter{Technical
Survey}\label{prep__030-technical-survey.md__technical-survey}}
...
\hypertarget{prep__030-technical-survey.md__deployment}{%
\section{Deployment}\label{prep__030-technical-survey.md__deployment}}
...
\tightlist
\item
  provisioning - Terraform \autocite{tfDocs}, Cloud Formation
  \autocite{cfDocs}, etc.
\item
  deployment automation - Ansible \autocite{ansibleDocs}, Puppet
  \autocite{puppetDocs}, Chef\autocite{chefDocs}, etc.
\item
...
\hypertarget{prep__030-technical-survey.md__connectivity}{%
\section{Connectivity}\label{prep__030-technical-survey.md__connectivity}}
...
\hypertarget{prep__030-technical-survey.md__virtual-private-networks-vpns}{%
\subsection{Virtual Private Networks
(VPNs)}\label{prep__030-technical-survey.md__virtual-private-networks-vpns}}
...
\hypertarget{prep__030-technical-survey.md__decentralized-identifiers-dids-and-didcomm}{%
\subsection{Decentralized Identifiers (DIDs) and
DIDComm}\label{prep__030-technical-survey.md__decentralized-identifiers-dids-and-didcomm}}
...
\hypertarget{prep__030-technical-survey.md__the-onion-router-tor}{%
\subsection{The Onion Router
(TOR)}\label{prep__030-technical-survey.md__the-onion-router-tor}}
...
\hypertarget{prep__030-technical-survey.md__summary}{%
\section{Summary}\label{prep__030-technical-survey.md__summary}}
...
\hypertarget{prep__050-implementation.md}{}
\hypertarget{prep__050-implementation.md__implementation-details}{%
\chapter{Implementation
details}\label{prep__050-implementation.md__implementation-details}}
...
\hypertarget{prep__050-implementation.md__reproducible-development-of-mpyc}{%
\section{Reproducible development of
MPyC}\label{prep__050-implementation.md__reproducible-development-of-mpyc}}
...
\hypertarget{prep__050-implementation.md__building-a-nixos-image-for-digitalocean}{%
\section{Building a NixOS image for
DigitalOcean}\label{prep__050-implementation.md__building-a-nixos-image-for-digitalocean}}
...
\hypertarget{prep__050-implementation.md__building-a-nixos-image-for-raspberrypi}{%
\section{Building a NixOS image for
RaspberryPi}\label{prep__050-implementation.md__building-a-nixos-image-for-raspberrypi}}
...
\hypertarget{prep__050-implementation.md__provisioning-via-terraform}{%
\section{Provisioning via
Terraform}\label{prep__050-implementation.md__provisioning-via-terraform}}
...
\hypertarget{prep__050-implementation.md__importing-the-image}{%
\subsubsection{Importing the
image}\label{prep__050-implementation.md__importing-the-image}}
...
\hypertarget{prep__050-implementation.md__generating-hostnames}{%
\subsubsection{Generating
hostnames}\label{prep__050-implementation.md__generating-hostnames}}
...
\hypertarget{prep__050-implementation.md__provisioning-the-hosts}{%
\subsubsection{Provisioning the
hosts}\label{prep__050-implementation.md__provisioning-the-hosts}}
...
\hypertarget{prep__050-implementation.md__interfacing-with-other-tools}{%
\subsubsection{Interfacing with other
tools}\label{prep__050-implementation.md__interfacing-with-other-tools}}
...
\hypertarget{prep__050-implementation.md__colmena-deployment}{%
\section{Colmena
deployment}\label{prep__050-implementation.md__colmena-deployment}}
...
\hypertarget{prep__050-implementation.md__runtime-execution}{%
\section{Runtime
execution}\label{prep__050-implementation.md__runtime-execution}}
...
\hypertarget{prep__050-implementation.md__secrets}{%
\section{Secrets}\label{prep__050-implementation.md__secrets}}
...
\hypertarget{prep__060-conclusions.md}{}
\hypertarget{prep__060-conclusions.md__conclusions}{%
\chapter{Conclusions}\label{prep__060-conclusions.md__conclusions}}
...
\hypertarget{prep__060-conclusions.md__implementation-phase-planning}{%
\subsubsection{Implementation phase
planning}\label{prep__060-conclusions.md__implementation-phase-planning}}
