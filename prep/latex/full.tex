...
\chapter{Connectivity}\label{connectivity}}
...
impact the performance of the multiparty computations due to their
\gls{p2p} nature.
...
\section{Decentralized Identifiers (DIDs) and
...
\section{The Onion Router (TOR)}\label{the-onion-router-tor}}
...
\part{Implementation details}\label{implementation-details}}
...
\chapter{Reproducible development of
...
\chapter{Building a NixOS image for
...
\chapter{Provisioning via Terraform}\label{provisioning-via-terraform}}
...
\subsection{Importing the image}\label{importing-the-image}}
...
\subsection{Generating hostnames}\label{generating-hostnames}}
...
\subsection{Provisioning the hosts}\label{provisioning-the-hosts}}
...
\subsection{Interfacing with other
...
\chapter{Colmena deployment}\label{colmena-deployment}}
...
\chapter{Runtime execution}\label{runtime-execution}}
