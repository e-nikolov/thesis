...
\part{Nix - Basic flake.nix}\label{nix---basic-flake.nix}}
...
\part{Nix - flake.lock}\label{nix---flake.lock}}
...
\part{Nix - Development Shell}\label{nix---development-shell}}
...
\part{Nix - MPyC Package}\label{nix---mpyc-package}}
...
\part{Nix - DigitalOcean Image (1)}\label{nix---digitalocean-image-1}}
...
\part{Nix - DigitalOCean Image (2)}\label{nix---digitalocean-image-2}}
...
\part{Nix - RaspberryPi Image}\label{nix---raspberrypi-image}}
...
\part{Terraform - Image Import}\label{terraform---image-import}}
...
\part{Colmena - hosts.json}\label{colmena---hosts.json}}
