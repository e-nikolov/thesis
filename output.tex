...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.25\textheight]{notion/../figures/nat-intro.png}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth,height=0.25\textheight]{notion/../figures/nat-traversal.png}
