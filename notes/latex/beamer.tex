\begin{frame}
\phantomsection\label{notes__000-intro.md}
\makeatletter
\def\fps@figure{h}
\makeatother

\begin{frame}{Intro}
\phantomsection\label{notes__000-intro.md__intro}
\begin{itemize}
\item
...
\phantomsection\label{notes__02000-related-work.md}
\begin{frame}{Related work}
\phantomsection\label{notes__02000-related-work.md__related-work}
\begin{itemize}
\item
...
\phantomsection\label{notes__02010-osi-model.md}
\begin{frame}{OSI Model}
\phantomsection\label{notes__02010-osi-model.md__osi-model}
\begin{itemize}
\tightlist
\item
...
\includegraphics[width=0.5\textwidth,height=0.3\textheight]{notes/../figures/osi-model-2.png} \includegraphics[width=0.4\textwidth,height=0.3\textheight]{notes/../figures/osi-model-1.png}
...
\caption{OSI model mapping\textbar500}
\end{figure}
...
\caption{OSI model mapping 2\textbar500}
\end{figure}
...
\phantomsection\label{notes__02020-primitives.md}
\begin{block}{Primitives}
\phantomsection\label{notes__02020-primitives.md__primitives}
\end{block}

\phantomsection\label{notes__02021-internet-protocol.md}
\begin{block}{Internet Protocol}
\phantomsection\label{notes__02021-internet-protocol.md__internet-protocol}
\begin{itemize}
\item
  IP addresses
...
\phantomsection\label{notes__02021-internet-protocol.md__network-address-translation-nat-traversal}
...
\phantomsection\label{notes__02021-internet-protocol.md__session-traversal-utilities-for-nat-stun}
\begin{itemize}
\item
...
\phantomsection\label{notes__02021-internet-protocol.md__traversal-using-relays-around-nat-turn}
\begin{itemize}
\item
...
\phantomsection\label{notes__02021-internet-protocol.md__universal-plug-and-play-upnp}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02021-internet-protocol.md__interactive-connectivity-establishment-ice}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02021-internet-protocol.md__designated-encrypted-relay-for-packets-derp}
\begin{itemize}
\item
...
\phantomsection\label{notes__02022-noise.md}
\begin{block}{Noise Protocol Framework}
\phantomsection\label{notes__02022-noise.md__noise-protocol-framework}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02025-identity.md}
\begin{block}{Identity}
\phantomsection\label{notes__02025-identity.md__identity}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02040-basic-ip.md}
\begin{block}{Basic Internet Protocol solution}
\phantomsection\label{notes__02040-basic-ip.md__basic-internet-protocol-solution}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02050-vpns.md}
\begin{block}{Virtual Private Networks (VPNs)}
\phantomsection\label{notes__02050-vpns.md__virtual-private-networks-vpns}
\begin{itemize}
\item
  asd
\item
...
\phantomsection\label{notes__02051-wireguard.md}
\begin{block}{Wireguard}
\phantomsection\label{notes__02051-wireguard.md__wireguard}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02052-tailscale.md}
\begin{block}{Tailscale}
\phantomsection\label{notes__02052-tailscale.md__tailscale}
\begin{itemize}
\tightlist
\item
  Mesh VPN
...
\phantomsection\label{notes__02053-headscale.md}
\begin{block}{Headscale}
\phantomsection\label{notes__02053-headscale.md__headscale}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02054-nebula.md}
\begin{block}{Nebula}
\phantomsection\label{notes__02054-nebula.md__nebula}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02055-zero-tier.md}
\begin{block}{ZeroTier}
\phantomsection\label{notes__02055-zero-tier.md__zerotier}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02056-n2n.md}
\begin{block}{N2N}
\phantomsection\label{notes__02056-n2n.md__n2n}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02058-tinc.md}
\begin{block}{Tinc}
\phantomsection\label{notes__02058-tinc.md__tinc}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02059-netbird.md}
\begin{block}{Netbird}
\phantomsection\label{notes__02059-netbird.md__netbird}
\begin{itemize}
\tightlist
\item
  WireGuard VPN
...
\phantomsection\label{notes__02090-didcomm.md}
\begin{block}{DIDComm v2}
\phantomsection\label{notes__02090-didcomm.md__didcomm-v2}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02100-ngrok.md}
\begin{block}{ngrok}
\phantomsection\label{notes__02100-ngrok.md__ngrok}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02110-ethereum.md}
\begin{block}{Ethereum's P2P Protocol}
\phantomsection\label{notes__02110-ethereum.md__ethereums-p2p-protocol}
\end{block}

\phantomsection\label{notes__02120-ipfs.md}
\begin{block}{IPFS}
\phantomsection\label{notes__02120-ipfs.md__ipfs}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02130-tor.md}
\begin{block}{TOR}
\phantomsection\label{notes__02130-tor.md__tor}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02140-freenet.md}
\begin{block}{Freenet}
\phantomsection\label{notes__02140-freenet.md__freenet}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02150-teleport.md}
\begin{block}{Teleport}
\phantomsection\label{notes__02150-teleport.md__teleport}
\begin{itemize}
\tightlist
\item
  Layer 7
...
\phantomsection\label{notes__02160-bittorrent.md}
\begin{block}{BitTorrent}
\phantomsection\label{notes__02160-bittorrent.md__bittorrent}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02170-webrtc.md}
\begin{block}{WebRTC}
\phantomsection\label{notes__02170-webrtc.md__webrtc}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__02180-openziti.md}
\begin{block}{OpenZiti}
\phantomsection\label{notes__02180-openziti.md__openziti}
\begin{itemize}
\tightlist
\item
  Network Overlay
...
\phantomsection\label{notes__03000-implementations.md}
\begin{frame}[fragile]{Implementation notes}
\phantomsection\label{notes__03000-implementations.md__implementation-notes}
\begin{block}{Headscale}
\phantomsection\label{notes__03000-implementations.md__headscale}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__03010-python-web.md}
\begin{frame}{Native}
\phantomsection\label{notes__03010-python-web.md__native}
...
\phantomsection\label{notes__03010-python-web.md__transcrypt}
...
\begin{frame}{Brython}
\phantomsection\label{notes__03010-python-web.md__brython}
...
\begin{frame}{Skulpt}
\phantomsection\label{notes__03010-python-web.md__skulpt}
...
\begin{frame}{Pyodide}
\phantomsection\label{notes__03010-python-web.md__pyodide}
...
\phantomsection\label{notes__03010-python-web.md__micropython}
...
\phantomsection\label{notes__03010-python-web.md__rustpython}
...
\phantomsection\label{notes__03100-python.md}
\begin{block}{Web Browser Python}
\phantomsection\label{notes__03100-python.md__web-browser-python}
\begin{block}{Overview}
\phantomsection\label{notes__03100-python.md__overview}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__03100-python.md__transpilers}
\begin{figure}
\centering
...
\phantomsection\label{notes__03100-python.md__interpreters}
...
\phantomsection\label{notes__03500-brainstorm.md}
\begin{frame}{Brainstorm for custom solutions}
\phantomsection\label{notes__03500-brainstorm.md__brainstorm-for-custom-solutions}
\begin{itemize}
\tightlist
\item
  Initial state
...
\phantomsection\label{notes__04000-writing.md}
\begin{frame}{Writing}
\phantomsection\label{notes__04000-writing.md__writing}
\begin{itemize}
\item
...
\phantomsection\label{notes__05000-prep.md}
\begin{frame}{Preparation phase report outline}
\phantomsection\label{notes__05000-prep.md__preparation-phase-report-outline}
\begin{block}{Introduction}
\phantomsection\label{notes__05000-prep.md__introduction}
\begin{itemize}
\tightlist
\item
  \begin{itemize}
...
\phantomsection\label{notes__05000-prep.md__technical-survey}
\begin{itemize}
\tightlist
\item
  Deployment
...
\phantomsection\label{notes__05000-prep.md__implementation-details}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__05000-prep.md__conclusions}
\end{block}
\end{frame}

\phantomsection\label{notes__06000-thesis.md}
\begin{frame}{Thesis outline}
\phantomsection\label{notes__06000-thesis.md__thesis-outline}
\begin{block}{Introduction}
\phantomsection\label{notes__06000-thesis.md__introduction}
\begin{itemize}
\tightlist
\item
  Background information
...
\phantomsection\label{notes__06000-thesis.md__related-work-literature-review}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__06000-thesis.md__methodology-approach}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__06000-thesis.md__solutionimplementation-evaluations}
\begin{itemize}
\tightlist
\item
  For each solution
...
\begin{block}{Conclusions}
\phantomsection\label{notes__06000-thesis.md__conclusions}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__07000-general.md}
\begin{block}{Notes}
\phantomsection\label{notes__07000-general.md__notes}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__08000-feedback.md}
\begin{frame}{Feedback}
\phantomsection\label{notes__08000-feedback.md__feedback}
\begin{itemize}
\tightlist
\item
  Glossary
...
\phantomsection\label{notes__09000-questions.md}
\begin{frame}{Questions}
\phantomsection\label{notes__09000-questions.md__questions}
\begin{itemize}
\tightlist
\item
...
\phantomsection\label{notes__09999-latex.md}
\begin{frame}[fragile]{Latex}
\phantomsection\label{notes__09999-latex.md__latex}
\begin{itemize}
\tightlist
\item
...
Location
\end{minipage}} & \multicolumn{3}{>{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.3333} + 4\tabcolsep}@{}}{%
\begin{minipage}[b]{\linewidth}\raggedright
