...
\chapter{Intro}\label{notes__000-intro.md__intro}
...
\chapter{Related work}\label{notes__02000-related-work.md__related-work}
...
\chapter{OSI Model}\label{notes__02010-osi-model.md__osi-model}
...
\subsubsection{Network Address Translation (NAT) Traversal}\label{notes__02021-internet-protocol.md__network-address-translation-nat-traversal}
...
\subsubsection{Universal Plug and Play (UPnP)}\label{notes__02021-internet-protocol.md__universal-plug-and-play-upnp}
...
\subsection{Noise Protocol Framework}\label{notes__02022-noise.md__noise-protocol-framework}
...
\item
  Built with the \hyperref[notes__02022-noise.md]{Noise Protocol Framework}d
\item
...
\section{Tailscale}\label{notes__02052-tailscale.md__tailscale}
...
\item
  Mesh VPN
\item
  Built on top of \hyperref[notes__02051-wireguard.md]{Wireguard}
\item
  ...
  \item
    Closed source
  \item
    Facilitates \href{notes/0202-nat\#Session\%20Traversal\%20Utilities\%20for\%20NAT\%20(STUN)}{STUN}/\hyperref[notes__02021-internet-protocol.md__test]{TURN} for peer discovery and NAT traversal
  \item
...
\section{Headscale}\label{notes__02053-headscale.md__headscale}
...
\section{Nebula}\label{notes__02054-nebula.md__nebula}
...
\section{ZeroTier}\label{notes__02055-zero-tier.md__zerotier}
...
\section{N2N}\label{notes__02056-n2n.md__n2n}
...
\section{Tinc}\label{notes__02058-tinc.md__tinc}
...
\section{Netbird}\label{notes__02059-netbird.md__netbird}
...
\section{DIDComm v2}\label{notes__02090-didcomm.md__didcomm-v2}
...
\chapter{Skulpt}\label{notes__03010-python-web.md__skulpt}
...
\section{Related work / Literature review}\label{notes__06000-thesis.md__related-work-literature-review}
