...
\part{OSI Model}\label{osi-model}}
...
\chapter{Basic Internet Protocol
...
\chapter{ZeroTier}\label{zerotier}}
...
\chapter{DIDComm v2}\label{didcomm-v2}}
...
\chapter{Ethereum's P2P Protocol}\label{ethereums-p2p-protocol}}

\hypertarget{ipfs}{%
\chapter{IPFS}\label{ipfs}}
...
\chapter{Teleport}\label{teleport}}
...
\chapter{BitTorrent}\label{bittorrent}}
...
\chapter{OpenZiti}\label{openziti}}
...
\part{Implementation notes}\label{implementation-notes}}
...
\part{Thesis outline}\label{thesis-outline}}
...
\chapter{Related work / Literature
...
\chapter{Methodology / Approach}\label{methodology-approach}}
...
\part{Questions}\label{questions}}
