...
\phantomsection\label{thesis__010-intro.md__introduction}
\end{block}
\end{frame}

\phantomsection\label{thesis__020-internet.md}
\begin{frame}[fragile]{The State of Multiparty Communications over the Internet}
\phantomsection\label{thesis__020-internet.md__the-state-of-multiparty-communications-over-the-internet}
\todo{include a section on MPC?}

\begin{block}{Internet Communications}
\phantomsection\label{thesis__020-internet.md__sec:internet}
...
Services that are implemented as Application layer (L7) protocols on top of TCP/IP include the \gls{www}, file transfer (\as{ftp}), email (\as{smtp}), instant messaging, remote access (\as{ssh} \autocite{sshRFC}) and others. The Web is a collection of interconnected documents that use Web technologies such as \as{html} and JavaScript. It is typically accessed via a user-agent software such as a \textbf{Web Browser}.
...
\phantomsection\label{thesis__020-internet.md__communication-protocols}
\begin{block}{Network Layer (L3)}
\phantomsection\label{thesis__020-internet.md__network-layer-l3}
The \as{ip} \autocite{ipv4RFC} is a Network layer (L3) protocol of the Internet Protocol Suite that is responsible for transferring datagrams between devices across the boundaries of their \glspl{lan} by possibly routing them via multiple intermediate devices (e.g.~routers). A datagram is a self-contained unit of data, typically associated with connectionless protocols that provide no guarantees for delivery or ordering (e.g.~IP, UDP). \todo{packet is the physical envelope of the IP datagram} IP datagrams have a header that contains fields such as the \textbf{IP addresses} of its source and destination, and a \todo{show a diagram of the internet with multiple local networks} payload that encapsulates the data from the Transport Layer (L4) protocols. A \textbf{router} is a device that is part of multiple networks and relays datagrams between them based on a routing table that maps IP address ranges to networks.
\end{block}

\begin{block}{Transport Layer (L4)}
\phantomsection\label{thesis__020-internet.md__transport-layer-l4}
...
\phantomsection\label{thesis__020-internet.md__application-layer-l7}
...
\phantomsection\label{thesis__020-internet.md__secure-communication-protocols}
...
\phantomsection\label{thesis__020-internet.md__transport-layer-l4-to-application-layer-l7}
\af{tls} \autocite{tlsRFC} and its precursor \gls{ssl} are protocols that provide secure communications to Application layer (L7) protocols on top of a reliable Transport layer (L4) protocol like \gls{tcp}. \gls{dtls} is a related protocol that works with connectionless transport protocols like \as{udp}. TLS is usually placed somewhere between the Presentation layer (L6) and the Transport layer (L4) because Application layer (L7) protocols use it as a transport protocol while having to manage the TLS connections.
...
\begin{block}{Network Layer (L3)}
\phantomsection\label{thesis__020-internet.md__network-layer-l3-1}
...
\begin{block}{IPSec}
\phantomsection\label{thesis__020-internet.md__ipsec}
...
\phantomsection\label{thesis__020-internet.md__openvpn-protocol}
\begin{itemize}
\tightlist
\item
\item
...
\phantomsection\label{thesis__020-internet.md__wireguard}
...
\phantomsection\label{thesis__020-internet.md__challenges-and-solutions-for-multiparty-communications}
...
\phantomsection\label{thesis__022-overlays.md__sec:overlays}
...
\phantomsection\label{thesis__022-overlays.md__data-link-layer-l2-and-network-layer-l3}
\begin{block}{Client/Server VPNs}
\phantomsection\label{thesis__022-overlays.md__clientserver-vpns}
...
\item
  ...
  \item
    ...
    \item
      ...
      Most overlay networks use a combination of the NAT traversal techniques mentioned previously. They can be placed in Layers 2, 3 or 7. Layer 2 overlays act as a virtual network switch, while Layer 3 overlays act as a virtual network router. Layer 7 overlays are implemented in user-space as libraries or applications that run on top of the network stack of the host operating system. Layer 2 and 3 overlays can either be implemented as kernel modules or as user-space applications that use a \textbf{TUN/TAP} \todo{explain the names} driver to interface with the kernel.
    \end{itemize}
...
\phantomsection\label{thesis__022-overlays.md__openvpn-clientserver}
...
\phantomsection\label{thesis__022-overlays.md__mesh-vpns}
\begin{itemize}
\tightlist
\item
  Tinc
...
\begin{block}{Application Layer (L7)}
\phantomsection\label{thesis__022-overlays.md__application-layer-l7}
\begin{block}{OpenZiti}
\phantomsection\label{thesis__022-overlays.md__openziti}
...
\begin{block}{LibP2P}
\phantomsection\label{thesis__022-overlays.md__libp2p}
\begin{itemize}
\tightlist
\item
  libP2P
...
\phantomsection\label{thesis__025-identity.md__digital-identities-for-multiparty-computations}
...
\phantomsection\label{thesis__030-methods.md__proof-of-concepts-and-evaluation}
\begin{block}{Testing methodology}
\phantomsection\label{thesis__030-methods.md__testing-methodology}
...
\phantomsection\label{thesis__030-methods.md__measuring-performance}
...
\phantomsection\label{thesis__030-methods.md__security}
...
\phantomsection\label{thesis__030-methods.md__usability}
...
\phantomsection\label{thesis__050-internet-protocol.md__internet-protocol-based-solution}
...
\phantomsection\label{thesis__050-internet-protocol.md__implementation-details}
...
\phantomsection\label{thesis__050-internet-protocol.md__performance-analysis}
\end{block}

\begin{block}{Security analysis}
\phantomsection\label{thesis__050-internet-protocol.md__security-analysis}
\end{block}

\begin{block}{Usability analysis}
\phantomsection\label{thesis__050-internet-protocol.md__usability-analysis}
\end{block}
\end{block}

\phantomsection\label{thesis__060-wireguard.md}
\begin{block}{WireGuard based solution}
\phantomsection\label{thesis__060-wireguard.md__wireguard-based-solution}
This solution creates an overlay network by manually configuring WireGuard on each machine.

\begin{block}{Implementation details}
\phantomsection\label{thesis__060-wireguard.md__implementation-details}
\end{block}

\begin{block}{Performance analysis}
\phantomsection\label{thesis__060-wireguard.md__performance-analysis}
\end{block}

\begin{block}{Security analysis}
\phantomsection\label{thesis__060-wireguard.md__security-analysis}
\end{block}

\begin{block}{Usability analysis}
\phantomsection\label{thesis__060-wireguard.md__usability-analysis}
\end{block}
\end{block}

\phantomsection\label{thesis__070-tailscale.md}
\begin{block}{Tailscale based solution}
\phantomsection\label{thesis__070-tailscale.md__tailscale-based-solution}
Tailscale is a VPN solution that configures a mesh of direct Wireguard tunnels between the peers.

\begin{block}{Implementation details}
\phantomsection\label{thesis__070-tailscale.md__implementation-details}
\end{block}

\begin{block}{Performance analysis}
\phantomsection\label{thesis__070-tailscale.md__performance-analysis}
\end{block}

\begin{block}{Security analysis}
\phantomsection\label{thesis__070-tailscale.md__security-analysis}
\begin{block}{Trust model}
\phantomsection\label{thesis__070-tailscale.md__trust-model}
...
\phantomsection\label{thesis__070-tailscale.md__identity}
...
\phantomsection\label{thesis__080-headscale.md__headscale-based-solution}
...
\begin{block}{Implementation details}
\phantomsection\label{thesis__080-headscale.md__implementation-details}
\end{block}

\begin{block}{Performance analysis}
\phantomsection\label{thesis__080-headscale.md__performance-analysis}
\end{block}

\begin{block}{Security analysis}
\phantomsection\label{thesis__080-headscale.md__security-analysis}
\begin{block}{Trust model}
\phantomsection\label{thesis__080-headscale.md__trust-model}
There still is a centralized service like in the Tailscale solution, but here it is self-deployed.
\end{block}

\begin{block}{Identity}
\phantomsection\label{thesis__080-headscale.md__identity}
\end{block}
\end{block}

\begin{block}{Usability analysis}
\phantomsection\label{thesis__080-headscale.md__usability-analysis}
\end{block}
\end{block}

\phantomsection\label{thesis__090-mpyc-web.md}
\begin{block}{MPyC Web}
\phantomsection\label{thesis__090-mpyc-web.md__mpyc-web}
...
\phantomsection\label{thesis__090-mpyc-web.md__python-runtime-selection}
\begin{block}{Selection Criteria}
\phantomsection\label{thesis__090-mpyc-web.md__selection-criteria}
...
\phantomsection\label{thesis__090-mpyc-web.md__available-solutions}
...
\phantomsection\label{thesis__090-mpyc-web.md__preliminary-runtime-benchmarks}
\begin{itemize}
\tightlist
\item
\item
...
\NormalTok{bench\_input\_size }\OperatorTok{=} \DecValTok{100000}
\NormalTok{bench\_min\_duration }\OperatorTok{=} \FloatTok{0.2}
\NormalTok{bench\_best\_of }\OperatorTok{=} \DecValTok{3}

\KeywordTok{def}\NormalTok{ is\_brython():}
    \ControlFlowTok{return} \StringTok{"Brython"} \KeywordTok{in} \BuiltInTok{str}\NormalTok{(sys.version)}
\KeywordTok{def}\NormalTok{ is\_skulpt():}
    \ControlFlowTok{return} \StringTok{"Skulpt"} \KeywordTok{in} \BuiltInTok{str}\NormalTok{(sys.version)}
\KeywordTok{def}\NormalTok{ is\_micropython():}
    \ControlFlowTok{return} \StringTok{"MicroPython"} \KeywordTok{in} \BuiltInTok{str}\NormalTok{(sys.version)}
\KeywordTok{def}\NormalTok{ is\_rustpython():}
    \ControlFlowTok{return} \StringTok{"rustc"} \KeywordTok{in} \BuiltInTok{str}\NormalTok{(sys.version)}
\ControlFlowTok{if}\NormalTok{ is\_micropython():}
    \ImportTok{import}\NormalTok{ js}
    \KeywordTok{def} \BuiltInTok{print}\NormalTok{(s):}
\NormalTok{        js.document.currentScript.target.innerHTML }\OperatorTok{+=}\NormalTok{ s }\OperatorTok{+} \StringTok{"\textless{}br /\textgreater{}"}  
\ControlFlowTok{if}\NormalTok{ is\_brython() }\KeywordTok{or}\NormalTok{ is\_skulpt() }\KeywordTok{or}\NormalTok{ is\_micropython():}
\NormalTok{    range\_fn }\OperatorTok{=} \BuiltInTok{range}
\ControlFlowTok{else}\NormalTok{:}
\NormalTok{    range\_fn }\OperatorTok{=} \KeywordTok{lambda}\NormalTok{ iters: itertools.repeat(}\VariableTok{None}\NormalTok{, iters)  }\CommentTok{\# Pyodide  }

\ControlFlowTok{if} \BuiltInTok{hasattr}\NormalTok{(time, }\StringTok{"ticks\_ms"}\NormalTok{):}
\NormalTok{    default\_timer }\OperatorTok{=}\NormalTok{ time.ticks\_ms}
\NormalTok{    default\_time\_diff }\OperatorTok{=} \KeywordTok{lambda}\NormalTok{ a, b: time.ticks\_diff(a, b) }\OperatorTok{/} \FloatTok{1000.0}
\ControlFlowTok{elif} \BuiltInTok{hasattr}\NormalTok{(time, }\StringTok{"time"}\NormalTok{):}
\NormalTok{    default\_timer }\OperatorTok{=}\NormalTok{ time.time}
\NormalTok{    default\_time\_diff }\OperatorTok{=} \KeywordTok{lambda}\NormalTok{ a, b: a }\OperatorTok{{-}}\NormalTok{ b}
\KeywordTok{def}\NormalTok{ timeit(func, iterations}\OperatorTok{=}\NormalTok{bench\_input\_size, timer}\OperatorTok{=}\NormalTok{default\_timer, time\_diff}\OperatorTok{=}\NormalTok{default\_time\_diff):}
\NormalTok{    t1 }\OperatorTok{=}\NormalTok{ timer()}
\NormalTok{    res }\OperatorTok{=}\NormalTok{ func()}
    \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in}\NormalTok{ range\_fn(iterations }\OperatorTok{{-}} \DecValTok{1}\NormalTok{):}
\NormalTok{        func()}
\NormalTok{    timing }\OperatorTok{=}\NormalTok{ time\_diff(timer(), t1)}
    \ControlFlowTok{return}\NormalTok{ timing, res}
\KeywordTok{def}\NormalTok{ autorange(func):}
\NormalTok{    i }\OperatorTok{=} \DecValTok{1}
    \ControlFlowTok{while} \VariableTok{True}\NormalTok{:}
        \ControlFlowTok{for}\NormalTok{ j }\KeywordTok{in} \DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{:}
\NormalTok{            iterations }\OperatorTok{=}\NormalTok{ i }\OperatorTok{*}\NormalTok{ j}
\NormalTok{            time\_taken, res }\OperatorTok{=}\NormalTok{ timeit(func, iterations)}
            \ControlFlowTok{if}\NormalTok{ time\_taken }\OperatorTok{\textgreater{}=}\NormalTok{ bench\_min\_duration:}
                \ControlFlowTok{return}\NormalTok{ (}\BuiltInTok{round}\NormalTok{(iterations }\OperatorTok{/}\NormalTok{ time\_taken, }\DecValTok{2}\NormalTok{), res)}
\NormalTok{        i }\OperatorTok{*=} \DecValTok{10}
\KeywordTok{def}\NormalTok{ bench(func):}
    \KeywordTok{def}\NormalTok{ wrapper(}\OperatorTok{*}\NormalTok{args, }\OperatorTok{**}\NormalTok{kwargs):}
\NormalTok{        maxOpS }\OperatorTok{=} \DecValTok{0}
\NormalTok{        res }\OperatorTok{=} \VariableTok{None}
        \KeywordTok{def}\NormalTok{ handle():}
            \ControlFlowTok{return}\NormalTok{ func(}\OperatorTok{*}\NormalTok{args, }\OperatorTok{**}\NormalTok{kwargs)}
        \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(bench\_best\_of):}
\NormalTok{            ops, res }\OperatorTok{=}\NormalTok{ autorange(handle)}
\NormalTok{            maxOpS }\OperatorTok{=} \BuiltInTok{max}\NormalTok{(maxOpS, ops)}
\NormalTok{        print\_bench(func.}\VariableTok{\_\_name\_\_}\NormalTok{, maxOpS, }\OperatorTok{*}\NormalTok{args, }\OperatorTok{**}\NormalTok{kwargs)}
        \ControlFlowTok{return}\NormalTok{ res}
    \ControlFlowTok{return}\NormalTok{ wrapper}
\KeywordTok{def}\NormalTok{ print\_bench(name, t, }\OperatorTok{*}\NormalTok{args, }\OperatorTok{**}\NormalTok{kwargs):}
\NormalTok{    args\_repr }\OperatorTok{=}\NormalTok{ [}\BuiltInTok{repr}\NormalTok{(arg) }\ControlFlowTok{for}\NormalTok{ arg }\KeywordTok{in}\NormalTok{ args]}
\NormalTok{    kwargs\_repr }\OperatorTok{=}\NormalTok{ [}\SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{key}\SpecialCharTok{\}}\SpecialStringTok{=}\SpecialCharTok{\{}\BuiltInTok{repr}\NormalTok{(value)}\SpecialCharTok{\}}\SpecialStringTok{"} \ControlFlowTok{for}\NormalTok{ key, value }\KeywordTok{in}\NormalTok{ kwargs.items()]}
\NormalTok{    args\_fmt }\OperatorTok{=} \StringTok{", "}\NormalTok{.join(args\_repr }\OperatorTok{+}\NormalTok{ kwargs\_repr)}
    \BuiltInTok{print}\NormalTok{(}\SpecialStringTok{f"}\SpecialCharTok{\{}\NormalTok{name}\SpecialCharTok{\}}\SpecialStringTok{(}\SpecialCharTok{\{}\NormalTok{args\_fmt}\SpecialCharTok{\}}\SpecialStringTok{): }\SpecialCharTok{\{}\NormalTok{t}\SpecialCharTok{:,\}}\SpecialStringTok{ ops/sec"}\NormalTok{)}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ assign(iters}\OperatorTok{=}\NormalTok{bench\_input\_size):}
    \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in}\NormalTok{ range\_fn(iters):}
\NormalTok{        x }\OperatorTok{=} \DecValTok{1}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ multiply(iters}\OperatorTok{=}\NormalTok{bench\_input\_size):}
\NormalTok{    a, b }\OperatorTok{=} \DecValTok{17}\NormalTok{, }\DecValTok{41}
    \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in}\NormalTok{ range\_fn(iters):}
\NormalTok{        x }\OperatorTok{=}\NormalTok{ a }\OperatorTok{*}\NormalTok{ b}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ bigints(iters}\OperatorTok{=}\NormalTok{bench\_input\_size):}
\NormalTok{    n }\OperatorTok{=} \DecValTok{60}
    \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in}\NormalTok{ range\_fn(iters):}
        \DecValTok{2}\OperatorTok{**}\NormalTok{n}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ randlist(size}\OperatorTok{=}\NormalTok{bench\_input\_size):}
    \ControlFlowTok{return}\NormalTok{ [random.randint(}\DecValTok{0}\NormalTok{, size) }\ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in} \BuiltInTok{range}\NormalTok{(size)]}
\NormalTok{l }\OperatorTok{=} \VariableTok{None}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ cpylist():}
    \ControlFlowTok{return}\NormalTok{ l.copy()}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ cpylist2():}
    \ControlFlowTok{return}\NormalTok{ l[:]}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ sortlist():}
    \ControlFlowTok{return}\NormalTok{ l.copy().sort()}
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ fibonacci(n}\OperatorTok{=}\NormalTok{bench\_input\_size):}
...
    \ControlFlowTok{for}\NormalTok{ \_ }\KeywordTok{in}\NormalTok{ range\_fn(n }\OperatorTok{{-}} \DecValTok{1}\NormalTok{):}
\NormalTok{        a, b }\OperatorTok{=}\NormalTok{ b, (a }\OperatorTok{+}\NormalTok{ b) }\OperatorTok{\%} \DecValTok{100000}
    \ControlFlowTok{return}\NormalTok{ a }
\AttributeTok{@bench}
\KeywordTok{def}\NormalTok{ primes(n}\OperatorTok{=}\NormalTok{bench\_input\_size):}
    \ControlFlowTok{if}\NormalTok{ n }\OperatorTok{==} \DecValTok{2}\NormalTok{:}
        \ControlFlowTok{return}\NormalTok{ [}\DecValTok{2}\NormalTok{]}
    \ControlFlowTok{if}\NormalTok{ n }\OperatorTok{\textless{}} \DecValTok{2}\NormalTok{:}
        \ControlFlowTok{return}\NormalTok{ []}
\NormalTok{    s }\OperatorTok{=} \BuiltInTok{list}\NormalTok{(}\BuiltInTok{range}\NormalTok{(}\DecValTok{3}\NormalTok{, n }\OperatorTok{+} \DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{))}
\NormalTok{    mroot }\OperatorTok{=}\NormalTok{ n}\OperatorTok{**}\FloatTok{0.5}
\NormalTok{    half }\OperatorTok{=}\NormalTok{ (n }\OperatorTok{+} \DecValTok{1}\NormalTok{) }\OperatorTok{//} \DecValTok{2} \OperatorTok{{-}} \DecValTok{1}
\NormalTok{    i }\OperatorTok{=} \DecValTok{0}
\NormalTok{    m }\OperatorTok{=} \DecValTok{3}
    \ControlFlowTok{while}\NormalTok{ m }\OperatorTok{\textless{}=}\NormalTok{ mroot:}
        \ControlFlowTok{if}\NormalTok{ s[i]:}
\NormalTok{            j }\OperatorTok{=}\NormalTok{ (m }\OperatorTok{*}\NormalTok{ m }\OperatorTok{{-}} \DecValTok{3}\NormalTok{) }\OperatorTok{//} \DecValTok{2}
\NormalTok{            s[j] }\OperatorTok{=} \DecValTok{0}
            \ControlFlowTok{while}\NormalTok{ j }\OperatorTok{\textless{}}\NormalTok{ half:}
\NormalTok{                s[j] }\OperatorTok{=} \DecValTok{0}
\NormalTok{                j }\OperatorTok{+=}\NormalTok{ m}
\NormalTok{        i }\OperatorTok{=}\NormalTok{ i }\OperatorTok{+} \DecValTok{1}
\NormalTok{        m }\OperatorTok{=} \DecValTok{2} \OperatorTok{*}\NormalTok{ i }\OperatorTok{+} \DecValTok{3}
    \ControlFlowTok{return}\NormalTok{ [}\DecValTok{2}\NormalTok{] }\OperatorTok{+}\NormalTok{ [x }\ControlFlowTok{for}\NormalTok{ x }\KeywordTok{in}\NormalTok{ s }\ControlFlowTok{if}\NormalTok{ x]}
\NormalTok{assign()}
\NormalTok{multiply()}
\NormalTok{bigints()}
\NormalTok{l }\OperatorTok{=}\NormalTok{ randlist()}
\NormalTok{cpylist()}
\NormalTok{cpylist2()}
\NormalTok{sortlist()}
\NormalTok{fibonacci()}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 8\tabcolsep) * \real{0.1146}}
...
\phantomsection\label{thesis__090-mpyc-web.md__design-of-mpyc-web}
...
\begin{block}{Implementation details}
\phantomsection\label{thesis__090-mpyc-web.md__implementation-details}
\end{block}

\begin{block}{Performance analysis}
\phantomsection\label{thesis__090-mpyc-web.md__performance-analysis}
\end{block}

\begin{block}{Security analysis}
\phantomsection\label{thesis__090-mpyc-web.md__security-analysis}
\begin{block}{Trust model}
\phantomsection\label{thesis__090-mpyc-web.md__trust-model}
There still is a centralized service like in the Tailscale solution, but here it is self-deployed.
\end{block}

\begin{block}{Identity}
\phantomsection\label{thesis__090-mpyc-web.md__identity}
\end{block}
\end{block}

\begin{block}{Usability analysis}
\phantomsection\label{thesis__090-mpyc-web.md__usability-analysis}
\end{block}
\end{block}
