...
\begin{figure}
\centering
\includegraphics[width=\textwidth,height=0.8\textheight]{thesis/../Excalidraw/osi-map.excalidraw.png}
\caption{OSI model mapping\textbar775}
\end{figure}

\hypertarget{internet-protocol}{%
\section{Internet protocol}\label{internet-protocol}}

\hypertarget{ipv4-routing}{%
\subsubsection{IPv4 routing}\label{ipv4-routing}}

\hypertarget{nat}{%
\subsubsection{NAT}\label{nat}}

\hypertarget{nat-traversal}{%
\subsubsection{NAT Traversal}\label{nat-traversal}}
...
\hypertarget{stun-and-turn}{%
\subsubsection{STUN and TURN}\label{stun-and-turn}}
