...
\hypertarget{network-layer-l3-security-protocols}{%
\subsection{Network Layer (L3) Security
Protocols}\label{network-layer-l3-security-protocols}}
...
\tightlist
\item
  An application sends \as{udp} datagrams to the STUN server
\item
