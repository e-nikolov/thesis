...
% \markdownInput{notion/02-goals.md}

\setkeys{Gin}{scale=0.25}
% \markdownInput{notion/03-technical-survey.md}
% % \markdownInput{notion/04-design.md}
% \markdownInput{notion/05-implementation.md}
% \markdownInput{notion/06-conclusions.md}
