...
\usepackage{arydshln} % surround environments with tags
...
\newcommand\MT{\rule{0pt}{3ex}}         % = `top' strut
\newcommand\MB{\rule[-2ex]{0pt}{0pt}}   % = `bottom' strut
\newcommand\HL{\hdashline\MT\MB}
\newcommand\HLM{\hdashline\MT}
\newcommand\HF{\hline\MT\MB}
\newcommand\HFM{\hline\MT}
\begin{document}
